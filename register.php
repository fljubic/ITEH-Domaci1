...
<body>
  <form method="POST">
    ...
    <label for="confirm_password">Потврдите лозинку:</label>
    <input type="password" id="confirm_password" name="confirm_password">
    <label for="email">Имејл-адреса:</label>
    <input type="email" id="email" name="email">
    <input type="submit" name="submit" value="РЕГИСТРУЈТЕ СЕ">
  </form>

  <div class="card-footer" style="text-align: center; color:white;">
    <div class="d-flex justify-content-center links">
      Већ сте регистровани? <a href="login.php" style="color: white">Пријавите се!</a>
    </div>
